...
const testAppFile = manifest.testApp;
const destinationFolder = path.dirname(mainFile);
const destinationTestAppFolder = path.dirname(testAppFile);
const exportFileName = path.basename(mainFile, path.extname(mainFile));
const exportTestAppFileName = path.basename(testAppFile, path.extname(testAppFile));
...
gulp.task('doc', function (cb) {
    ...
    gulp.src(['./src/zyphublib.js','./src/message.js'], {read: false})
